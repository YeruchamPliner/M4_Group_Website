...
- **Build Tool**: Vite
- **Routing**: Wouter
- **Backend**: Express.js (minimal, primarily for serving frontend)
...
- **July 13, 2025**: Increased company logo size by 300%

## Current Status
- ✅ Basic landing page structure complete
- ✅ Hero section with slideshow functionality
- ✅ Navigation between pages
- ✅ Responsive design implemented
- ⏳ Content sections need completion
- ⏳ Contact forms need implementation
- ⏳ Project portfolio needs content

## User Preferences
- Focus on nursing and rehabilitation homes (not hospitals or general healthcare)
- All images must be from United States locations
...
- Images sourced from Unsplash with specific geographic targeting
