      ...
      <div className="container mx-auto px-6 py-24 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Building excellence through innovation, expertise, and unwavering commitment to quality
          </p>
        </motion.div>
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              With over 25 years of experience in the construction industry, M4 Development Group has established itself as a premier design-build firm specializing in healthcare facilities, commercial properties, and multi-family residential projects.
            </p>
